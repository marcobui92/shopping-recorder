...
export function LegalPage({ kind }: LegalPageProps) {
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <Link className="text-sm font-semibold text-primary hover:underline" to="/">← Back to Shopping Recorder</Link>
      <p className="mt-8 text-sm font-semibold uppercase tracking-[0.18em] text-primary">Shopping Recorder</p>
      ...
      {privacy ? <div className="prose mt-10 max-w-none text-sm leading-7 text-muted-foreground">
        <p>Shopping Recorder helps operators record packing and unpacking evidence for their own operational records. This policy explains what we collect and how we use it.</p>
        ...
        <p>Evidence is stored in the application storage configured by the service or, when you choose it, in your connected Google Drive. Google Drive access is optional and limited to files created by Shopping Recorder. We store encrypted authorization tokens so the connection can be maintained.</p>
        ...
        <h2>Contact</h2>
        <p>For privacy questions or data requests, contact the Shopping Recorder service owner through the support channel provided with your deployment.</p>
      </div> : <div className="prose mt-10 max-w-none text-sm leading-7 text-muted-foreground">
        <p>These Terms govern your use of Shopping Recorder, an operational workspace for recording packing and unpacking evidence.</p>
        <h2>Your account</h2>
        ...
        <h2>Availability</h2>
        <p>Shopping Recorder is provided as configured for your deployment. Features may be changed to maintain security, comply with provider requirements, or improve the service.</p>
        <h2>Contact</h2>
        <p>For support or terms questions, contact the Shopping Recorder service owner through the support channel provided with your deployment.</p>
      </div>}
    </article>
  )
}
